    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link to="/admin/users" className="p-6 border rounded hover:shadow opacity-60 cursor-not-allowed">
            <h3 className="font-semibold">Users (coming soon)</h3>
            <p className="text-sm text-gray-500 mt-2">User management (optional)</p>
          </Link>
        </div>
      </div>
    </div>
